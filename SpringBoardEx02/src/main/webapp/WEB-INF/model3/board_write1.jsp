...
<script type="text/javascript">
	window.onload = function() {				
		document.getElementById( 'wbtn' ).onclick = function() {
			var str = document.wfrm.upload.value.lastIndexOf(".");
			var strSub = document.wfrm.upload.value.substr(str,str+4).toLowerCase();
			...
			if(strSub != ".jpg" && strSub != ".gif" && strSub != ".png" && strSub != "") {
				alert('이미지 파일을 올려주세요.');
				return false;
			}
