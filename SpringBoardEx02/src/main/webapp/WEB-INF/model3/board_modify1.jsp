...
<div class="contents1"> 
	...
	<form action="./modify_ok.do" method="post" name="dfrm" enctype="multipart/form-data">	
		...
		<!--게시판-->
			...
			<div class="btn_area">
				...
				<div class="align_right">			
					<input type="button" value="수정" id="ubtn" class="btn_write btn_txt01" style="cursor: pointer;" />
				</div>	
			</div>	
			<!--//게시판-->
		</div>
